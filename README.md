...
![Window1](https://github.com/DawKaw/dr1801A6_import/assets/97156574/150e07f3-9fd2-4bcc-9c55-36bf881633f1)

**To compile** the program, follow the standard steps for compiling applications written in QT C++.<br>
No additional libraries are required. You can open the *.proj file with QT Creator and build it.<br>
...
![Window2](https://github.com/DawKaw/dr1801A6_import/assets/97156574/3eb3c215-9e4e-464d-a34c-c62daa464b29)

**Aby skompilować** program postępuj według standardowych kroków przy kompilowaniu aplikacji napisanych w QT C++.<br>
Nie wymagane są żadne dodatkowe biblioteki. Możesz Otworzyć plik *.proj programem QT Creator i kliknąć budowanie.<br>
